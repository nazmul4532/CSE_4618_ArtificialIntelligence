...
def cornersHeuristic(state, problem):
    ...
    currPosition, currVisitedCorners = state
    maxDistance = 0
...
def foodHeuristic(state, problem):
    ...
    return mazeDistance(position,nearestFood,problem.startingGameState) + mazeDistance(nearestFood, farthestFood,problem.startingGameState)
